...
import desktop from "@/public/assets/images/webinar/soccer/1.avif";
import phone from "@/public/assets/images/webinar/soccer/2.avif";
import player from "@/public/assets/images/webinar/soccer/3.avif";
import { LazyMotion, domAnimation } from "framer-motion";

import { usePathname } from "next/navigation";
// import titleimage from "@/public/assets/images/webinar/soccer/title.png";
  ...
  return (
    <section className="flex-center-col size-full overflow-hidden">
      <LazyMotion features={domAnimation}>
        <Hero
          title="The PERFECT method to improve your Soccer performance"
          alt="SOCCER title"
          video={"https://player.vimeo.com/video/984543819?"} // Change the video ID to the id of the webinar video
        />
        <DelayComponent delay={60000}>
          <InfoSection
            ...
            paragraph1={`
              <p>At BestLevel, we offer you an exceptional training experience with exclusive benefits that will help you reach your full potential, especially if you're a Soccer player.</p>
              <br>
              <ul style="padding-left: 0; list-style-type: none;">
                ...
                <li style="margin-bottom: 10px; display: flex; align-items: baseline;">
                  <span style="color: white; padding-right: 5px;">•</span>
                  <div><strong style="color: white;">Personalized Service:</strong> Receive clear and specific guidance tailored to your individual needs in Soccer to improve your skills and performance.</div>
                </li>
                <li style="margin-bottom: 10px; display: flex; align-items: baseline;">
                  <span style="color: white; padding-right: 5px;">•</span>
                ...
                <li style="margin-bottom: 10px; display: flex; align-items: baseline;">
                  <span style="color: white; padding-right: 5px;">•</span>
                  <div><strong style="color: white;">Take Off in Your Sports Career:</strong> Make a difference and take the leap that others dare not try. With BestLevel, you'll be closer to achieving your dreams in the world of Soccer.</div>
                </li>
              </ul>
              <br>
            `}
            ...
            paragraph2={`
              <p>Discover the path to your peak performance with BestLevel’s methodology. Our training guidance is designed to fit your individual needs in Soccer, ensuring tangible improvements in your on-field performance.</p>
              <br>
              ...
              <br>
              <p>Transform the way you train and reach your peak performance as a Soccer player.</p>
            `}
