...
export async function GET(request: NextRequest) {
  const fileNames = [
    ...
    "ad2-9FXlvHd8sIFoIko3FcXtXYFzVtmBFP.mp4",  // Cambia esto por el nombre real del archivo
    "ad3-ohHIb4DSImxt4iRVCdLaoKuETKXZSD.mp4",  // Cambia esto por el nombre real del archivo
    "ad4-XQ7YcFvayB3tqRQI9fipDOZhlOtibM.mp4"   // Cambia esto por el nombre real del archivo
